...
import { generateDimensions, staticDimensionStyles } from '@/theme/dimensions';
import { staticEffects } from '@/theme/effects';
...
function ThemeProvider({ children, storage }) {
  ...
  }, [variant, layout, fonts, backgrounds, borders, effects, fullConfig.colors]);
